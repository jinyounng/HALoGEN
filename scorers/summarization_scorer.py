'''
This module contains the summarization scorer class.
...
if __name__ == "__main__":
    ...
    for each_response_file in glob.glob("../model_hallucinations/summarization/*.csv"):

        model_name = each_response_file.split("_summarization")[0].split("/")[-1]


        summ_scorer = SummScorer(each_response_file)
